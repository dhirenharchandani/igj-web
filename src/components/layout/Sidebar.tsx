...
const NAV_ITEMS = [
  ...
  { href: '/analytics', label: 'Insights', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
    ...
    <aside className="hidden md:flex flex-col w-64 bg-slate-900 border-r border-slate-800 h-screen sticky top-0">
      <div className="p-6">
        <h1 className="text-xl font-bold text-white">
          <span className="text-indigo-400">Mindset</span> Journal
        </h1>
        <p className="text-xs text-slate-500 mt-1">High Performance Daily</p>
      </div>
